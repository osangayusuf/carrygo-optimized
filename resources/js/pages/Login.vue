...
<template>
    ...
    >
        <div class="pointer-events-none absolute inset-0 opacity-40">
            <div
                class="absolute -top-24 -left-24 h-96 w-96 rounded-full bg-secondary-container blur-[120px]"
            />
            <div
                class="absolute top-1/2 -right-24 h-64 w-64 rounded-full bg-primary-fixed blur-[100px]"
            />
        </div>
        ...
        <div class="relative z-10 w-full max-w-md">
            ...
            >
                <h1
                    class="mb-2 text-center font-headline text-3xl font-extrabold tracking-tight text-primary"
                >
                    Welcome back
                </h1>
                ...
                >
                    <div class="space-y-2">
                        <label
                            for="msisdn"
                            class="ml-1 block text-xs font-bold tracking-widest text-primary"
                        >
                            MSISDN
                        </label>
                        <input
                    ...
                    <p
                        v-if="wasSuccessful"
                        class="text-success text-center text-xs"
                    >
                    ...
                    <div class="mt-4 text-center text-xs text-primary">
                        ...
                        <a
                            href="tel:*20790#"
                            class="font-medium text-secondary underline-offset-2 hover:underline"
                        >
