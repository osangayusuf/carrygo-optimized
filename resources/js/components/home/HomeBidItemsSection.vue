...
<template>
    <section class="mx-auto max-w-screen-2xl px-8 pt-5 pb-8">
        ...
        <div
            v-else
            class="grid grid-cols-2 gap-4 md:grid-cols-3 md:gap-6 lg:grid-cols-4 xl:grid-cols-5"
        >
            <div
            ...
            >
                ...
                <div class="flex grow flex-col p-3 sm:p-4">
                    <div class="mb-3 flex items-start justify-between">
                        <h3
                            class="line-clamp-2 font-headline text-sm leading-tight font-extrabold sm:text-base"
                        >
                            {{ bid.name }}
                        </h3>
                        <div class="text-right">
                            <p
                                class="mb-0.5 text-[8px] font-bold tracking-wider text-secondary uppercase sm:text-[9px]"
                            >
                                Price
                            </p>
                            <p
                                class="text-base font-black whitespace-nowrap text-primary sm:text-lg"
                            >
                    ...
                    <div class="mt-auto py-2">
                        <div class="mb-2 flex items-center justify-between">
                            <span
                                class="text-[9px] font-bold text-secondary sm:text-[10px]"
                            >
                        ...
                        <div
                            class="mb-2 h-1.5 w-full overflow-hidden rounded-full bg-surface-container-highest"
                        >
                            <div
