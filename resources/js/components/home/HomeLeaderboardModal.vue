...
<template>
    <Teleport to="body">
        ...
        >
            ...
            <!-- Modal Content -->
            <div
                class="relative z-10 w-full max-w-md overflow-hidden rounded-3xl bg-surface-container-lowest p-6 shadow-2xl"
            >
                <button
                    type="button"
                ...
                <div
                    v-if="bid.top_bidders && bid.top_bidders.length > 0"
                ...
                >
                    <div
                        ...
                        :class="{
                            'border-2 border-tertiary/20 bg-tertiary/5':
                                index === 0,
                        }"
                    >
                        <div class="flex items-center gap-3">
                            ...
                            <span class="font-bold text-on-surface">{{
                                maskedPhone(bidder.msisdn)
                            }}</span>
                        </div>
                        <div class="text-right">
                            <span class="block text-xs font-bold text-outline"
                                >Points</span
                            >
                            <span class="font-black text-primary">{{
                                parseInt(bidder.total_points).toLocaleString()
                            }}</span>
                        </div>
                    </div>
                </div>
                ...
                >
                    <span
                        class="material-symbols-outlined mb-2 text-4xl text-outline"
                        >leaderboard</span
                    >
