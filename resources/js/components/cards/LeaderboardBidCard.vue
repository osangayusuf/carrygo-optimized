...
<template>
    ...
    >
        ...
        <div class="flex flex-1 flex-col p-3">
            ...
            <div class="mt-auto">
                <h4
                    class="mb-2 text-[9px] font-black tracking-widest text-sage-dark uppercase"
                >
                    Top Bidders
                </h4>
                ...
                >
                    <div
                        ...
                        :class="
                            index === 0
                                ? 'border border-sage-border bg-sage-light'
                    ...
                    >
                        ...
                        <span
                            ...
                            :class="
                                index === 0 ? 'text-forest' : 'text-sage-dark'
                            "
                        >
                ...
                >
                    <p class="text-[10px] font-bold text-sage-dark sm:text-xs">
                        No bids recorded
                    </p>
                    <p
                        class="mt-0.5 text-[9px] text-sage-dark/80 sm:text-[10px]"
                    >
