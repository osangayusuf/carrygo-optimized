...
<template>
    <Teleport to="body">
        ...
        >
            ...
            >
                <div class="border-b border-surface-container p-6 pb-2">
                    <button
                        type="button"
                    ...
                    <p class="mt-1 mb-4 text-sm text-outline">
                        {{ bid.name }}
                    </p>
                </div>
                ...
                <div class="flex-1 space-y-6 overflow-y-auto p-6">
                    ...
                    >
                        <h3
                            class="mb-3 text-sm font-bold tracking-widest text-secondary uppercase"
                        >
                            Past Reviews
                        </h3>
                        <div class="space-y-4">
                            ...
                            >
                                ...
                                <div
                                    ...
                                    "
                                    class="mb-2 flex items-center gap-1 text-xs font-medium text-primary"
                                >
                                ...
                                <!-- Share Row -->
                                <div
                                    class="mt-4 flex flex-wrap items-center justify-between gap-2 border-t border-surface-container pt-3 text-xs"
                                >
                                    ...
                                    <div class="flex items-center gap-2">
                                        <a
                                            :href="`https://api.whatsapp.com/send?text=${encodeURIComponent(reviewShareText(bid.name) + ' ' + reviewShareUrl(review.id))}`"
                                            target="_blank"
                                            class="flex items-center justify-center rounded-full bg-[#25D366]/10 p-1.5 text-[#25D366] transition-transform hover:scale-105"
                                            title="Share on WhatsApp"
                                        >
                                            <span
                                                class="pi pi-whatsapp text-xs"
                                            ></span>
                                        </a>
                                        <a
                                            :href="`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(reviewShareUrl(review.id))}`"
                                            target="_blank"
                                            class="flex items-center justify-center rounded-full bg-[#1877F2]/10 p-1.5 text-[#1877F2] transition-transform hover:scale-105"
                                            title="Share on Facebook"
                                        >
                                            <span
                                                class="pi pi-facebook text-xs"
                                            ></span>
                                        </a>
                                        <a
                                            :href="
                                                xShareUrl(review.id, bid.name)
                                            "
                                            target="_blank"
                                            class="flex items-center justify-center rounded-full bg-black/10 p-1.5 text-black transition-transform hover:scale-105"
                                            title="Share on X"
                                        >
                                            <span
                                        ...
                                        <a
                                            ...
                                            target="_blank"
                                            class="flex items-center justify-center rounded-full bg-primary/10 p-1.5 text-primary transition-transform hover:scale-105"
                                        ...
                                        <button
                                            @click="copyReviewLink(review.id)"
                                            class="flex cursor-pointer items-center justify-center rounded-full bg-secondary/10 p-1.5 text-secondary transition-transform hover:scale-105"
                                            :title="
                                                activeCopiedId === review.id
                                                    ? 'Copied!'
                                                    : 'Copy Link'
                                            "
                                        >
                    ...
                    <div v-else-if="mode !== 'write'">
                        <p class="text-sm text-outline italic">
                    ...
                    <div v-if="mode === 'write'">
                        <h3
                            class="mb-4 text-sm font-bold tracking-widest text-primary uppercase"
                        >
                        ...
                        <form @submit.prevent="submit">
                            ...
                            <div class="mb-4">
                                ...
                                <div
                                    class="flex cursor-pointer items-center gap-1 text-amber-500"
                                >
                                    <svg
                                        v-for="i in 5"
                                        :key="i"
                            ...
                            <div class="mb-4 grid grid-cols-2 gap-4">
                                <div>
                                    <label
                                        class="mb-2 block text-xs font-bold text-outline uppercase"
                                    >
                                        Social Platform
                                        <span
                                            class="font-normal tracking-normal text-secondary/50 lowercase"
                                            >(Optional)</span
                                        >
                                    </label>
                                    <select
                                        v-model="form.social_platform"
                                        class="w-full appearance-none rounded-2xl border border-surface-container bg-surface-container-low px-4 py-3 text-sm font-medium focus:border-primary focus:ring-2 focus:ring-primary-container disabled:opacity-50"
                                    ...
                                    <p
                                        v-if="form.errors.social_platform"
                                        class="mt-2 text-xs font-bold text-error"
                                    >
                                ...
                                <div>
                                    ...
                                    />
                                    <p
                                        v-if="form.errors.social_handle"
                                        class="mt-2 text-xs font-bold text-error"
                                    >
